...
// GetAll return all consignments
...
func main() {
	...
	srv := service.New(service.Name("shippy.service.consignment"))

	srv.Init()

	// Register service
	if err := pb.RegisterShippingServiceHandler(srv.Server(), &consignmentService{repo}); err != nil {
		log.Panic(err)
	}
